...
function nightingale_2_0_register_required_plugins() {
    ...
    $plugins = array(
        ...
        array(
            'name'               => 'Gutenberg', // The plugin name.
            'slug'               => 'gutenberg', // The plugin slug (typically the folder name).
            'source'             => '', // The plugin source.
            'required'           => true, // If false, the plugin is only 'recommended' instead of required.
            'version'            => '6.3.0', // E.g. 1.0.0. If set, the active plugin must be this version or higher. If the plugin version is higher than the plugin version installed, the user will be notified to update the plugin.
