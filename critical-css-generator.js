...
penthouse({
    ...
    forceInclude: [
        ...
        '.nhsuk-header--white .nhsuk-header__transactional-service-name',
        '.nhsuk-header__transactional-service-name--link',
        '.nhsuk-header--white .nhsuk-header__transactional-service-name--link',
        '.nhsuk-header__organisation-name',
        '.nhsuk-header--white .nhsuk-header__organisation-name',
        '.nhsuk-header__organisational-qualifier',
        '.nhsuk-header--white .nhsuk-header__organisational-qualifier',
        '.nhsuk-organisation-name',
        '.nhsuk-header--white .nhsuk-organisation-name',
        '.nhsuk-organisation-descriptor',
        '.nhsuk-header--white .nhsuk-organisation-descriptor',
        '.nhsuk-transaction-name',
        '.nhsuk-header--white .nhsuk-transaction-name',
