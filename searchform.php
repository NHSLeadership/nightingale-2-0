...
<form class="nhsuk-header__search-form" <?php echo esc_attr( $search_form ); ?> id="search" action="/" method="get" role="search">
	...
	<input class="nhsuk-header__search-input nhsuk-input" id="<?php echo esc_attr( $search_field ); ?>" name="s" type="search" placeholder="<?php echo esc_attr__( 'Search', 'nightingale' ); ?>" autocomplete="off">
