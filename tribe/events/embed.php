...
function nightingale_events_embed_head() {
    ?>
    <link rel="stylesheet" id="nightingale-style" href="<?php echo get_template_directory_uri() . '/style.min.css'; ?>" type="text/css" media="all">
    <link rel="stylesheet" id="nightingale-page-colours" href="<?php echo get_template_directory_uri() . '/page-colours.min.css'; ?>" type="text/css" media="all">
    <style>
        html {
...
add_action( 'embed_head', 'nightingale_events_embed_head' );
get_header( 'embed' );
