	...
	<div class="tribe-block tribe-block__events-link">
		...
		<?php if ( $has_google_cal ) : ?>
			<div class="tribe-block__btn--link tribe-block__events-gcal">
				...
				>
					<img alt="Google Calendar link" src="<?php echo esc_url( Tribe__Main::instance()->plugin_url . 'src/modules/icons/link.svg' ); ?>" />
		...
		<?php if ( $has_ical ) : ?>
			<div class="tribe-block__btn--link tribe-block__-events-ical">
				...
				>
					<img alt="iCalendar file download link" src="<?php echo esc_url( Tribe__Main::instance()->plugin_url . 'src/modules/icons/link.svg' ); ?>" />
