...
<div class="tribe-common-b1 tribe-common-b2--min-medium tribe-tickets__form-field tribe-tickets__form-field--required">
	<label
		class="nhsuk-label tribe-tickets__form-field-label"
	...
	<input
		type="email"
		class="nhsuk-input tribe-common-form-control-text__input tribe-tickets__form-field-input tribe-tickets__rsvp-form-field-email"
