...
$logo_line_1 = $org_name_checkbox === 'no' ? get_bloginfo( 'name' ) : get_theme_mod( 'org_name_field' );
$logo_line_2 = $org_name_checkbox === 'no' ? get_bloginfo( 'description' ) : get_bloginfo( 'name' );
