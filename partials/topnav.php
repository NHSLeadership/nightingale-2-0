...
$mobile_toggle_menu = '<li class="nhsuk-header__menu" hidden>
...
$topmenu_args       = array(
	...
	'items_wrap'      => '<div class="nhsuk-header__navigation-container nhsuk-width-container"><ul id="%1$s" class="%2$s">%3$s' . $mobile_toggle_menu . '</ul></div>',
