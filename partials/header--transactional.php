...
<div class="nhsuk-width-container nhsuk-header__container">
	...
	if ( has_custom_logo() ) {
		...
		<div class="nhsuk-header__logo nhsuk-header__logo--only">
			<a class="nhsuk-header__link" href="<?php echo get_home_url(); ?>" aria-label="<?php bloginfo( 'name' ); ?> homepage">
		...
		<div class="nhsuk-header__transactional-service-name">
			<a class="nhsuk-header__transactional-service-name--link" href="/"><?php echo esc_html( get_theme_mod( 'logo_title' ) ); ?></a>
		</div>
		<?php
	}
	?>
