	...
	<div class="nhsuk-width-container nhsuk-header__container">
        ...
        <div class="nhsuk-header__logo">
            <a class="nhsuk-header__link" href="/" aria-label="Anytown Anyplace Anywhere NHS Foundation Trust homepage">
                ...
                <span class="nhsuk-organisation-name"><?php echo get_theme_mod( 'logo_title' ); ?></span>
                <span class="nhsuk-organisation-descriptor"><?php echo get_theme_mod( 'logo_qualifier' ); ?></span>
            </a>
        </div>
        <?php } ?>
