...
// To do keep list context

function add_list_view( $view_context, $view_slug, $instance ){
...
// add_filter( 'tribe_events_views_v2_view_context', 'add_list_view', 15, 3 );


/**
 * Disable Gutenberg for events pages even if they have checked the enable btn
 */

// To do disable Gutenberg

function disable_gutenberg(){
	return true;
}

add_filter( 'tribe_is_classic_editor_plugin_active', 'disable_gutenberg' );
