 ...
 * @return array
 */
function nightingale_tribe_v2_additional_plugin_template_locations( $folders ) {
	// Example: /app/public/wp-content/plugins/my-plugin/tribe/
	$nightingale_base_path = trailingslashit( get_template_directory() . '/tribe/' );
...
add_filter( 'tribe_template_path_list', 'nightingale_tribe_v2_additional_plugin_template_locations' );
