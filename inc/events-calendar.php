...
function nightingale_events_buttons( $output ) {
	...
	// Style the gcal button.
	$output = str_replace( 'tribe-events-gcal', 'nhsuk-button--secondary', $output );
	$output = str_replace( 'tribe-tickets__rsvp-form-button', 'nhsuk-button--secondary', $output );
