...
if ( ! function_exists( 'nightingale_2_0_posted_on' ) ) :
	 ...
	 */
	function nightingale_2_0_posted_on() {
...
if ( ! function_exists( 'nightingale_2_0_posted_by' ) ) :
	/**
...
if ( ! function_exists( 'nightingale_2_0_entry_footer' ) ) :
	/**
	 * Prints HTML with meta information for the categories, tags and comments.
	 */
	function nightingale_2_0_entry_footer() {
			...
			comments_popup_link(
				sprintf(
					wp_kses(
						...
						__( 'Leave a Comment<span class="screen-reader-text"> on %s</span>', 'nightingale-2-0' ),
						array(
							'span' => array(
								'class' => array(),
							),
...
if ( ! function_exists( 'nightingale_2_0_post_thumbnail' ) ) :
	/**
	 ...
	 */
	function nightingale_2_0_post_thumbnail() {
